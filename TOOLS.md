...
用 WebSearch 搜好玩的图片，找到真实图片直链（.jpg/.png/.gif），用 pic.sh 发送：
...
示例：
```bash
bash /Users/evan/.openclaw/workspace-gf/pic.sh "https://i.imgur.com/xxx.jpg" "哈哈哈哈这只猫太搞笑了"
bash /Users/evan/.openclaw/workspace-gf/pic.sh "https://i.redd.it/xxx.png" "这个配色绝了 我要学"
```

找图技巧：
- 英文搜 "cute cat meme"、"funny animal"、"aesthetic art" 找到好图源
- 中文搜 "沙雕表情包"、"猫咪 可爱"
- Reddit (r/aww, r/funny)、Imgur 都是好图源
- 用 WebFetch 确认图片 URL 能打开再发
